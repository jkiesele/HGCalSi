...
outdir="irradiated_ann_27min/"

cv_plotter = curvePlotter(mode="CVs",path=globalpath)
iv_plotter = curvePlotter(mode="IVGR",path=globalpath)
ivpad_plotter = curvePlotter(mode="IV",path=globalpath)
...
for m in ['cv','iv']:
    ...
    plter.addPlotFromFile("1002_UL_diode_big_ann_27min/*"+m,
                               label="1002 (300µm), 6.5 E14 $neq/cm^2$, ann. 27.2min@60C", 
                               linestyle='dashed'
                               )
    
    
    plter.addPlotFromFile("1003_UL_diode_big_ann_27min/*."+m,
                               label="1003 (300µm), 1.0 E15 $neq/cm^2$, ann. 27.2min@60C",  
                               linestyle='dashed'
                               )
    
    
    plter.addPlotFromFile("1102_UL_diode_big_ann_27min/*."+m,
                               label="1102 (300µm), 1.5 E15 $neq/cm^2$, ann. 27.2min@60C",  
                               linestyle='dashed',
                               min_x=-850
                               )
    ...
    plt.legend(loc='lower left')
    plter.savePlot(outdir+m+"_1001_1002_1003_1102_to_no.pdf",nolegend=True)
    ...
    plter.addPlotFromFile("2002_UL_diode_big_ann_27min/2002_UL_diode_big_ann_*."+m,
                               label="2002 (200µm), 1E15 $neq/cm^2$, ann. 27.2min@60C",  
                               linestyle='dashed'
                               )
    
    
    plter.addPlotFromFile("2003_UL_diode_big_ann_27min/2003_UL_diode_big_ann_*."+m,
                               label="2003 (200µm), 1.5E15 $neq/cm^2$, ann. 27.2min@60C",  
                               linestyle='dashed'
                               )
    
    
    plter.addPlotFromFile("2102_UL_diode_big_ann_27min/2102_UL_diode_big_ann_*."+m,
                               label="2102 (200µm), 2.5E15 $neq/cm^2$, ann. 27.2min@60C",  
                               linestyle='dashed'
                               )
